...
amount.oninput = () =>{
  //TODO Obtém o valor atual do input e remove os caracteres não númericos

  //TODO Aceita só números
  let value = amount.value.replace(/\D/g, "")

  //TODO transforma o valor em centavos
  value = Number(value) / 100

  //TODO Atualiza o valor do input
...
function expenseAdd(newExpense){
  ...
  // Adiciona nome e  categoria em expense info
...
function updateTotals(){
 ...
 //Formata o valor e remover o R$ que serpa exibido pala small com um estilo customizado
